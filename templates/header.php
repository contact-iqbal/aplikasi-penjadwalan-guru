    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            <nav class="mt-2">
                ...
                $penjadwalan_pages = ['jadwal_wajib.php', 'susun_jadwal.php', 'lihat_jadwal.php'];
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item <?php echo $is_penjadwalan_active ? 'menu-open' : ''; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="susun_jadwal.php" class="nav-link <?php echo $current_page == 'susun_jadwal.php' ? 'active' : ''; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Susun Jadwal</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="lihat_jadwal.php" class="nav-link <?php echo $current_page == 'lihat_jadwal.php' ? 'active' : ''; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lihat & Cetak</p>
                                </a>
                            </li>
