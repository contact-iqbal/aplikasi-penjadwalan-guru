                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item text-danger" href="guru.php?action=delete_mapel&id=<?php echo $m['id_mapel']; ?>"
                                                           onclick="return confirm('Menghapus mapel akan menghapus semua penugasan dan jadwal terkait. Yakin?')">
                                        ...
                                        <td rowspan="<?php echo $assignment_count; ?>">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item text-danger" href="guru.php?action=delete&id=<?php echo $g['id_guru']; ?>"
                                                       onclick="return confirm('Menghapus guru akan menghapus semua jadwal dan penugasan terkait. Yakin?')">
                                                        <i class="fas fa-trash mr-2"></i> Hapus
                                                    </a>
                                                </div>
                                            </div>
...
document.getElementById('deleteAssignment').addEventListener('click', function() {
    if (currentAssignment) {
        if (confirm('Hapus penugasan ' + currentAssignment.mapel + ' untuk ' + currentAssignment.guru + '?\n\nSemua jadwal dan penugasan kelas terkait akan dihapus.')) {
